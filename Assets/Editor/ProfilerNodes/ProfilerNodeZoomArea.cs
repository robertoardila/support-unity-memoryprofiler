...
namespace UnityEditor.MemoryProfiler2
{
    ...
    public class ProfilerNodeZoomArea
    {
        ...
        public static Rect Begin(float zoomScale, Rect screenCoordsArea, float panX, float panY)
        {
            ...
            //GUI.matrix = Matrix4x4.TRS(Vector2.zero + new Vector2(panX, panY), Quaternion.identity, Vector3.one);
        ...
        public static void End(float panX, float panY)
        {
